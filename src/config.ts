...
export const receiptMaxDateGapDays = Number.parseInt(process.env.RECEIPT_MAX_DATE_GAP_DAYS ?? '30', 10);
export const receiptFuzzyMatchThreshold = Number.parseFloat(process.env.RECEIPT_FUZZY_MATCH_THRESHOLD ?? '0.50');
